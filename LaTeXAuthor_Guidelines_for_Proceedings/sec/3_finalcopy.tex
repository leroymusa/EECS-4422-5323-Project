...
Table~\ref{tab:method-comparison} summarizes the average accuracy, precision, recall, Dice, and pseudo-log-likelihood (PLL) for the evaluated configurations. Method C delivers the highest precision at \(K=3\), while the GMM maintains recall above \(0.96\) even when precision drops; switching to \(K=4\) raises Dice and improves the PLL, signaling a tighter probabilistic fit to the RGB distributions.
